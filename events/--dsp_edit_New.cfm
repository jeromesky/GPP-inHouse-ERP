...
<fieldset  >
	<legend>Event Costs (New Version, not working yet)</legend>
    
        
        <b> Currency</b>
        <i class="NoFormat" >#qryEvent.eventCurrencyLabel#</i>
        
        <b> Cost</b>
        <i  class="NoFormat" >#numberformat(qryEvent.eventPriceValue, "_____.__")#</i>

        
        <b>Discount </b>
        <i class="NoFormat" >#numberFormat(qryEvent.discountValue, "9999")#</i>
        
        <b>Discount End </b>
		<i  class="NoFormat">#dateformat(qryEvent.discountDate, "dd mmmm yyyy")#</i>
...
<!--- </td>
 ...
 <fieldset  >
	<legend>Event Location (New version, not working yet)</legend>
		<cf_Country_search_eip id="#qryEvent.webID#" countryID="#qryEvent.countryID#" fildName="fl_text CountryID" country="#qryEvent.countryName#"  path="../events/update_eventAjax.cfm">
</fieldset>
