...
</cfif><li><a href="##tabs-Speakers">Speakers/program</a></li>
...
<div id="tabs-EBlurb">
        ...
        <div class="column2" style="width:440px; padding:0 0 0 0; margin:0 0 0 15px; border:1px solid ##abc6dd">
...
<div class="column1" >
    ...
    <div id="logo_Contributing" >
		<cfif listLen(get_event.logo_Contributing, ",") GT 0 >
                ...
                FROM logos 
                <cfif listLen(get_event.logo_Contributing, ",") GT 1 >
                WHERE id IN (#get_event.logo_Contributing#)
                <cfelse>
