...
AND (event_type <> 'spon' and event_type <> 'both' OR event_type <> 'exh') 
...
<cfoutput>
  ...
  <div id="tabs">
      ...
      <table border="0" cellspacing="8" cellpadding="0" id="table">
        <tr>
          ...
          <td valign="top"><fieldset>
              ...
              <b>Event Live </b> <i class="NoFormat">
              <input type="checkbox" name="live" id="live" value="1" <cfif qryEvent.live eq 1>checked="checked"</cfif> />
              </i> <b>Event Title </b> <i class="fl_text" id="event_name">#qryEvent.event_name#</i> <b>Sub Title</b> <i class="fl_area" id="Slogan">#qryEvent.Slogan#</i> <b>Slogan </b> <i class="fl_area" id="briefingSlogan">#qryEvent.briefingSlogan#</i> <b>sticky Note</b> <i class="fl_area" id="sloganSub">#qryEvent.sloganSub#</i> <b>Start Date</b> <i class="fl_date" id="event_expire">#dateformat(qryEvent.event_expire, 'dd mmmm yyyy')#</i> <b>End Date</b> <i class="fl_date" id="eventDateEnd">#dateformat(qryEvent.eventDateEnd, 'dd mmmm yyyy')#</i>
            </fieldset>
            <fieldset>
            <cfif qryEvent.event_type Neq "event">
              <legend>Event Costs</legend>
              <b> Currency</b> <i class="event_cost_currency fl_comboShort" style="display: inline">#qryEvent.event_cost_currency#</i> 
              <b> Cost</b> <i class="fl_comboShort" title="event_cost_us" id="#qryEvent.webID#">#numberformat(qryEvent.event_cost_us, "_____.__")#</i> 
            </cfif>
            <cfif qryEvent.event_type eq "event">
              <b>Discount </b> <i class="fl_comboShort"  title="discountValue" id="#qryEvent.webID#">#numberFormat(qryEvent.discountValue, "9999")#</i> 
              <b>Discount End </b> <i  class="fl_date" id="discountDate">#dateformat(qryEvent.discountDate, "dd mmmm yyyy")#</i>
           </cfif>
            </fieldset></td>
          <td valign="top"><fieldset>
              <legend>Event Location</legend>
              <b>City</b> <i class="fl_text" id="event_loc_city">#qryEvent.event_loc_city#</i> <b> Country</b> <i class="event_loc_country fl_text" style="display: inline">#qryEvent.event_loc_country#</i> <b>Venue</b> <i class="hotel fl_text" style="display: inline">#get_venue.VenueName#</i> <b>Event Room name</b> <i class="fl_text" id="venuRoom">#qryEvent.venuRoom#</i>
            </fieldset>
            <fieldset>
              <legend>Event Settings</legend>
 
              <b>bookable </b> <i class="NoFormat" id="#qryEvent.webID#">
              <input type="checkbox" id="singleEventNot" value="1" <cfif qryEvent.singleEventNot eq 1>checked="checked"</cfif>  />
              </i> <b>colorD</b><i class="fl_comboShort" title="colorD">#qryEvent.colorD#</i> <b>colorL</b> <i class="fl_comboShort" title="colorL">#qryEvent.colorL#</i>
            </fieldset>
            <cfif qryEvent.event_type Neq "event">
            <fieldset>
              <legend>Contact Attendees</legend>
              <b>Fill Access</b> <i class="NoFormat"><a href=" qry_paswordUpdate.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#" rel="colorbox" class="button">Check Passwords</a></i> 
              <b>Attence Form</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=1&corespondence=1" rel="colorbox" class="button">send test</a></i> 
              <b>Attence Form</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=0&corespondence=1" rel="colorbox" class="button ">send final</a></i> <b>fill access</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=1&corespondence=2" rel="colorbox" class="button ">send test</a></i> 
              <b>Fill Access</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=0&corespondence=2" rel="colorbox" class="button">send final</a></i>
            </fieldset>
            </cfif>
            </td>
          <td valign="top">
          ...
          <fieldset>
              ...
              <cfif qryEvent.Econf EQ 1>
                yes
                <cfelse>
                no
              </cfif>
              </i> <b>registration Open time</b> <i class="fl_text" id="timereg">#qryEvent.timereg#</i> <b>Event start time</b> <i class="fl_text" id="timestart">#qryEvent.timestart#</i> <b>pre regist place</b> <i class="fl_text" id="preRegistration">#qryEvent.preRegistration#</i> <b>pre regist date</b> <i class="fl_date" id="preRegistrationDate">#DateFormat(qryEvent.preRegistrationDate, "dd mmmm yyyy")#</i> <b>pre regist time</b> <i class="fl_text" id="preRegistrationTime">#qryEvent.preRegistrationTime# </i> <b>presentation Available</b> <i class="fl_date" id="filesAvailableDate">#dateFormat(qryEvent.filesAvailableDate, "dd mmm yyyy")#</i> <b>Attand form Submit date</b> <i class="fl_date" id="AttendFormDate">#dateFormat(qryEvent.AttendFormDate, "dd mmm yyyy")#</i>
              <div class="clear"></div>
              <fieldset>
                <legend>Exibitions info</legend>
                <b>Booth setup time</b> <i class="fl_text" id="boothTimeSetup">#qryEvent.boothTimeSetup#</i> <b>Booth setup date</b> <i class="fl_date" id="boothDateSetup">#dateformat(qryEvent.boothDateSetup, "dd mmm yyyy")#</i> <b>Booth breakdown time</b> <i class="fl_text" id="boothTimeRemove">#qryEvent.boothTimeRemove#</i> <b>Booth breakdown date</b> <i class="fl_date" id="boothDateRemove">#dateformat(qryEvent.boothDateRemove, "dd mmm yyyy")#</i>
              </fieldset>
            </fieldset>
            </cfif>
            </td>
    ...
    <div id="tabs-Uploads">
      ...
      <b>Hotel Form</b> <i class="colorL fl_comboShort">
    ...
    <div id="tabs-EBlurb">
      ...
      <cfscript>
			...
			fckEditor.instanceName="event_blurb";
			fckEditor.id="event_blurb";
			fckEditor.basePath="../FCKeditor/";
			fckeditor.ToolbarSet="Basic";
			fckEditor.value="#qryEvent.event_blurb#";
			fckEditor.width="550";
      ...
      <cfscript>
			fckEditor[2] = createObject("component", "/FCKeditor/fckeditor");
			fckEditor[2].instanceName="focusOn";
			fckEditor[2].id="focusOn";
			fckEditor[2].basePath="../FCKeditor/";
			fckeditor[2].ToolbarSet="Basic";
			fckEditor[2].value="#qryEvent.focusOn#";
			fckEditor[2].width="550";
			fckEditor[2].height="440";
			fckEditor[2].canUpload="false";
			fckEditor[2].checkBrowser="false";
			fckEditor[2].create(); // create instance now.
			</cfscript>
      <br/>
    ...
    <cfif qryEvent.event_type EQ "week" OR qryEvent.event_type EQ "RE"  or qryEvent.event_type eq 'CLUB' or qryEvent.event_type eq 'BOOK' or qryEvent.event_type eq 'advis' or qryEvent.event_type eq 'CM' or qryEvent.event_type eq 'EB'>
      <div id="tabs-Sponsor">
        <form id="sponsorsBlurb" method="post" action="update_TextArea.cfm">
              <cfscript>
			fckEditor = createObject("component", "/FCKeditor/fckeditor");
			fckEditor.instanceName="event_blurb_sponsors";
			fckEditor.id="event_blurb_sponsors";
			fckEditor.basePath="../FCKeditor/";
			fckeditor.ToolbarSet="Basic";
			fckEditor.value="#qryEvent.event_blurb_sponsors#";
			fckEditor.width="550";
			fckEditor.height="440";
			fckEditor.canUpload="false";
			fckEditor.checkBrowser="false";
      ...
      <div id="tabs-Exhib">
        <form id="exhibBlurb" method="post" action="update_TextArea.cfm">
                      <cfscript>
			fckEditor4 = createObject("component", "/FCKeditor/fckeditor");
			fckEditor4.instanceName="event_blurb_exhib";
			fckEditor4.id="event_blurb_exhib";
			fckEditor4.basePath="../FCKeditor/";
			fckeditor4.ToolbarSet="Basic";
			fckEditor4.value="#qryEvent.event_blurb_exhib#";
			fckEditor4.width="550";
			fckEditor4.height="440";
			fckEditor4.canUpload="false";
			fckEditor4.checkBrowser="false";
			fckEditor4.create(); // create instance now.
			</cfscript>
