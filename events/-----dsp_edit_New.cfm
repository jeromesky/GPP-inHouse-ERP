      ...
      <table border="0" cellspacing="8" cellpadding="0" id="table">
        ...
        <i  class="event_abbr fl_comboShort" id="#qryEvent.webID#">#qryEvent.event_abbr#</i>---> 
            ...
            <cfif qryEvent.event_type Neq "week">
              ...
              <b>Fill Access</b> <i class="NoFormat"><a href=" qry_paswordUpdate.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#" rel="colorbox" class="button">Check Passwords</a></i> <b>Attence Form</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=1&corespondence=1" rel="colorbox" class="button">send test</a></i> <b>Attence Form</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=0&corespondence=1" rel="colorbox" class="button ">send final</a></i> <b>fill access</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=1&corespondence=2" rel="colorbox" class="button ">send test</a></i> <b>Fill Access</b> <i class="NoFormat"><a href="act_events_attendence.cfm?gppID=#qryEvent.id_gpp#&eventid=#qryEvent.webID#&test=0&corespondence=2" rel="colorbox" class="button">send final</a></i>
            </fieldset>
            </cfif>
            </td>
          <td valign="top">
...
<div id="dialog" title="Inportant Message">
  <p> <span class="ui-icon ui-icon-circle-check" style="float:left; margin:0 7px 50px 0;"></span> If you see this message, click OK, and press save 2 more times, on the field you where updating..<br>
    There was an error saving, Pressing two more times will fix the problem..<br>
    <br>
    In the process of solving issue.. <br>
  </p>
</div>
