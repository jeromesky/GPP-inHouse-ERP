...
<style type="text/css">
  #TableEdit { font-family:Arial, Helvetica; color:#000000; font-size:12px;}
...
<tr>
<td colspan=4 style="border-bottom:1px solid ##CCC;font-size:14px;"><strong>#ucase(qry_conf.company)#</strong></td>
</tr>
<cfoutput><tr>
<cfif url.indent GT 0><td style="width:#url.indent#px;"> </td></cfif>
<td>#ucase(qry_conf.title)# #ucase(qry_conf.name)# <!--- </span></td>
