<CFHEADER NAME="Content-Disposition" VALUE="inline; filename=exhibitors-#dateformat(now(), "yyyy-mm-dd")#-#randrange(1,99)#.xls">
...
<cfoutput query="qry_exhibitors" group='user_id'>
<cfsilent>
