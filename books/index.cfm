...
<div id="outer">
	<div id="iner">
<div style="">
    <div class="sectionHeader">Add a New Book</div>
    ...
    <form method="post" action="booksave.cfm" id="addbook">
	  <table width="800" border="0" cellspacing="4">
        <cfif parameterexists(form.publisher)><tr>
          <td colspan="4"> <span style="color:#CC3300">Book Added</span></td>
        </tr></cfif>
        <tr>
          <td width="115">Book Title</td>
          <td width="228"><input type="text" name="title"  maxlength="45" /></td>
          <td width="199" >Publisher</td>
          <td width="230" ><input type="text" name="publisher" maxlength="20" /></td>
        </tr>
        <tr>
          <td valign="top">Book subTitle</td>
          <td><textarea  name="subtitle"  maxlength="80" /></textarea></td>
          <td>Published date</td>
          <td valign="top"><input type="text" name="publishdate"  />
            <img src="../img/calendar_24.gif" border="0" onclick="scwShow(scwID('publishdate'),event,3);" /></td>
        </tr>
        <tr>
          <td>Author</td>
          <td><input type="text" name="author"  maxlength="80" /></td>
          <td>&nbsp;</td>
          <td><input name="submit" type="submit" /></td>
        </tr>
      </table>
    </form> 
      <div class="sectionHeader" style="margin:30px 0 0 0 ;">Add a Book Review</div>
     <div style="margin:2px 0 15px 0 ; border-bottom:1px dotted #336699"></div> 
