...
<script type="text/javascript">
	tinyMCE.init({
     ...
     <cfquery datasource="#dsnP21#" name="getboob">SELECT id, title FROM books ORDER BY title</cfquery>
     <table width="800" border="0" cellspacing="4">
        <tr>
         ...
         <td width="170" rowspan="5" valign="top" style="border-left:1px dotted #336699">
              	<ul>
       ...
       <tr>
         <td width="85">Date</td>
         <td><input type="text" name="publishdates"  /><img src="../img/calendar_24.gif" border="0" onclick="scwShow(scwID('publishdates'),event,3);" /></td>
         <td>Link</td>
         <td><label>
           <input type="text" name="link" maxlength="150" />
         </label></td>
       </tr>       
         <tr>
         <td width="85">Review</td>
