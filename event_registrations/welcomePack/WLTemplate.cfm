...
SELECT id, groupby, event_type, event_expire, event_days, event_month, event_year, event_name, event_loc_city AS city, event_loc_country AS country, venueaddress AS address, venuroom AS room, google, Enquir, exhEnq, sponEnq, accPay, GenCont, PaCont, AcoCont, VisCont, hotel, timereg, timestart, ColorD, ColorL
FROM events WHERE id = <cfqueryparam cfsqltype="cf_sql_integer" value="#I#">
</cfquery>--->
<!--- get events --->
<cfquery datasource="#dsnP21#" name="users" >
...
<cfif get.event_type EQ "event" OR get.event_type EQ "eb" OR get.event_type EQ "din" > 
	<cfquery datasource="#dsnP21#" name="hotel" >
		SELECT * FROM hotels where id = <cfqueryparam cfsqltype="cf_sql_integer" value="#get.hotel#">
	</cfquery>
</cfif>
<!--- get functions --->
...
WHERE event_welcom.eventid = <cfqueryparam cfsqltype="cf_sql_integer" value="#I#">
ORDER BY functiondate , functionTime
</cfquery>
<!--- get all events loop --->
<cfquery datasource="#dsnP21#" name="getall">
SELECT id, event_name, event_loc_hotel, event_year, event_days, event_month, event_type, event_loc_hotel AS hotel, groupby
FROM events
WHERE groupby = #get.groupby# AND event_year = '#get.event_year#' AND (event_type = 'week' OR event_type = 'event' OR event_type = 'EB' OR event_type = 'DIN') AND live= 1
ORDER BY event_type desc, event_expire
</cfquery>
<!--- get colors --->
		<cfquery datasource="#dsnP21#" name="getGroup">
			SELECT id, ColorD, ColorL
			FROM events WHERE groupby = #getall.groupby# AND event_year = #getall.event_year# AND event_type = 'week'
		</cfquery>

<cfset cleanFileName = replace(get.event_name," ","_","All") >
<cfset twoWeekBefore = createOdbcdate(get.event_expire-14) /> 
<cfset eventType = "" >
<cfdocument format="pdf" pagetype="A4" marginbottom="0.4" margintop="0.85" marginleft="0.01" marginright="0.01" filename="#GetDirectoryFromPath(GetTemplatePath())#/welcomePack/#cleanFileName#-#get.event_year#.pdf" overwrite="yes" >
...
<cfdocumentitem type="header" >
 <table border="0" width="100%" cellpadding="0" cellspacing="0" height="80" bgcolor="###getGroup.ColorD#">
 	<tr>
 	 <td ><div style="height:23px; margin:0 0 0 35px; font-size:20pt; color:##FFFFFF; vertical-align:top; padding:0px;line-height:80%;font-family:Georgia, "Times New Roman", Times, serif;">#event_name# #event_year#</div>
				 <div style=" font-family:Arial, Helvetica, sans-serif;height:18px; margin:0 0 0 35px; font-size:10pt; color:##FFFFFF;line-height:95%;">#event_days# #event_month# #event_year#, #city#, #country# </div>
...
<table width="100%" border="0" cellspacing="4" cellpadding="4" style="font-family:Arial, Helvetica, sans-serif; font-size:11px" >
 ...
 <tr> 
 		...
 		<tr> 
 		<td ><p>
		 <cfif get.event_type EQ "event" ><cfset eventType = "conference" >
			 We thank your registration/ request to the <strong>#get.event_name#</strong> on the <strong>#get.event_days# #get.event_month# #get.event_year#</strong>. Please find herewith details for the conference.
 <cfelseif get.event_type EQ "eb" ><cfset eventType = "Briefing" >
 We thank your registration/ request to the <strong>#get.event_name#</strong> on the <strong>#get.event_days# #get.event_month# #get.event_year#</strong>. Please find herewith details for the Briefing.
 <cfelseif get.event_type EQ "din" ><cfset eventType = "Dinner" >
 		We thank your registration/ request for <strong>#get.event_name#</strong> on the <strong>#get.event_days# #get.event_month# #get.event_year#</strong>. Please find herewith details for the Dinner.
 <cfelseif get.event_type EQ "club" ><cfset eventType = "Club Membership" >
 		We thank your Membership request for <strong>#get.event_name#</strong> Please find herewith details for the Club Membership.
 <cfelseif get.event_type EQ "book" ><cfset eventType = "book" >
 		We thank you for the order of <strong>#get.event_name#</strong> on Petro21.com Please find herewith details for your Book(s) order/purchase .
 <cfelseif get.event_type EQ "Advis" ><cfset eventType = "advisory" >
 		We thank you for your Order Request for <strong>#get.event_name#</strong> on Petro21.com. Please find herewith details for the Advisory order/ purchased.
 <cfelseif get.event_type EQ "WSO" ><cfset eventType = "World strategy online" >
 		We thank you for your order request for <strong>#get.event_name#</strong> on Petro21.com. Please find herewith details for the World Strategy Online.
 <cfelseif get.event_type EQ "RE" ><cfset eventType = "research" >
 		We thank you for your order request for <strong>#get.event_name#</strong> on Petro21.com. Please find herewith details for your Research order/ purchase.
 </cfif> 
 ...
 #hotel.address#<br />#hotel.city#, #hotel.country# </td>
 </tr>
 ...
 <td valign="top">#get.event_days# #get.event_month# #get.event_year#</td>
 </tr>
 <tr>
 	<td valign="top" align="right"><strong>Registration Time</strong></td>
 <td valign="top">#get.timereg#</td>
 </tr>
 <tr> 
...
<!--- STart show other events on the week --->
 ...
 <tr>
 	<td style=" font-size:10px; color:##666666">If you have not registered, and would like to attend any of the above events please send details to: email: <strong>sonika@glopac-partners.com</strong> Registrations fees apply.</td>
 ...
 <cfloop query="users"><cfif listcontains(get.Enquir, users.id, ",") NEQ "0" >
 	<strong>#trim(users.name)#</strong><br />
 	<span class="tel">#trim(users.tel)# or </span>
 #trim(users.email)#<!---<a href="#trim(users.email)#" class="email"></a>---><br />
 </cfif></cfloop> 
 ...
 <tr>
 	<td>
 <cfloop query="users"><cfif listcontains(get.exhenq, users.id, ",") NEQ "0" >
 	<strong>#trim(users.name)#</strong><br />
 <span class="tel">#trim(users.tel)# or </span>
 ...
 <tr>
 	<td>
<cfloop query="users"><cfif listcontains(get.sponenq, users.id, ",") NEQ "0" >
 	<strong>#trim(users.name)#</strong><br />
 <span class="tel">#trim(users.tel)# or </span>
 #trim(users.email)#<br />
 </cfif></cfloop> </td>
 ...
 <tr>
 	<td>
 <cfloop query="users"><cfif listcontains(get.accpay, users.id, ",") >
 	<strong>#trim(users.name)#</strong>: 
 #trim(users.email)#<br />
 </cfif></cfloop></td>
 </tr>
 <tr> 
 ...
 <tr>
 	<td>
 	<ol>
 		<li >Registration on #dateFormat(get.event_expire, "dddd, dd mmmm yyyy")# from <strong>#get.timereg#</strong> and #eventType# proceedings commences at <strong>#get.timestart#</strong></li>
 		<li>The #eventType# proceedings take place in The #get.room#</li>
...
<cfelse>
 ...
 For hotel Booking rates &amp; terms, please see attached or contact <cfloop query="users"><cfif listcontains(get.sponenq, users.id, "," ) ><a href="#trim(users.email)#" class="email">#trim(users.email)#</a>, tel: <span class="tel">#trim(users.tel)#</span>, </cfif></cfloop>
</cfif></p>
 ...
 <table width="100%" border="0" cellspacing="3" cellpadding="4" style="font-family:Arial, Helvetica, sans-serif; font-size:11px" >
 	<tr> 
 	<td style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:18px; border-bottom:4px solid ##ffffff; color:##666666" >Payment Of Registration Fees</td>
 </tr>
 <tr> 
 	<td height="15"></td>
 </tr>
...
<cfif get.event_type EQ "event" OR get.event_type EQ "eb" OR get.event_type EQ "din" > 
 ...
 <tr>
 	<td>
 <p>Your registration holds contractual obligation for payment/s due. However, any cancellation (in writing only) made before the <strong>#dateformat(twoWeekBefore, "dd mmmm yyyy")#</strong> prior to start of the #eventType# will be refunded with a 20% administration charge. Thereafter, refunds will not apply<cfif get.event_type NEQ "din"> but delegates will receive online access to relevant Conference Presentations</cfif>. Replacements are welcome. All Delegates registered for any #eventType# will be liable for full payment due under this contract unless cancellation has been made and duly acknowledged.</p>
...
<cfdocumentitem type = "pagebreak" />
<table width="100%" border="0" cellspacing="4" cellpadding="4" style="font-family:Arial, Helvetica, sans-serif; font-size:11px" >
<cfif get.event_type EQ "book" OR get.event_type EQ "Advis" OR get.event_type EQ "re" > 
 <tr>
