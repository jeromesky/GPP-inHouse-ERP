...
<cfset toogleList = '0'>
<cfoutput query="qry_audienceList">
<div align="left">

<form name="register" method="post" action="?">
<input type="hidden" name="fa" value="audienceUpdate">
<input type="hidden" name="fa" value="#audienceID#">

<fieldset>
  <legend>Edit an Audience</legend>

    <label>Name</label><input type="text" name="audienceName" maxlength="50" value="#AUDIENCEName#"><br />
  ...
  <fieldset>
    ...
    <td><input type="checkbox" class="checkbox" name="interestID" id="interestID" value="#qry_areas.areaID#" />#trim(qry_areas.areaName)#</td>
 ...
 <!---<fieldset>
  ...
  <fieldset><cfif len(AUDIENCECOMPANYLIST) GT 1 and AUDIENCECOMPANYLIST NEQ 1><cfset toogleList = "#toogleCounter#,#toogleList#,"></cfif>
    <legend onClick="toggle_visibility('#toogleCounter#');">Company</legend>
    <div id="#toogleCounter#" class="hidden"><cfset toogleCounter = toogleCounter +1>
    <table>
    <tr>
    <td valign="top">Search:</td>
    <td><div><input id="fbautocomplete_id" type="text" name='companyid' value="#AUDIENCECOMPANYLIST#" /></div></td>
      </tr>
      </table>      
      </div>
  </fieldset>
  ...
  <fieldset>
   <legend onClick="toggle_visibility('#toogleCounter#');">Events</legend>
    <div id="#toogleCounter#" class="hidden"><cfset toogleCounter = toogleCounter +1>  
    <cf_events_dropDown eventID="#AUDIENCEEVENTLIST#" fieldName="eventid" elapse="1" operator="IN" eventType="din,event,Bu_pr"><br>
    <hr color="white">
     <table>
    <tr>
    <td>Registered: </td>
...
<label>&nbsp;</label><input type="submit" name="submit" value="Update Audience"><br />

</fieldset>

<script><cfloop list="#toogleList#" index="tt">
  toggle_visibility('#tt#');</cfloop>
</script>
</form>
