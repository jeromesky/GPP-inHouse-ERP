...
FROM Counts_dinners
WHERE name = <cfqueryparam  value="#form.dish#" > AND webid  = <cfqueryparam cfsqltype="cf_sql_integer" value="#form.id#" >
 </cfquery>
...
WHERE IngIndividual_ID IN (#getIDS#) 
 ...
 <table width="420" border="0" cellspacing="1" cellpadding="4" style="font-family:Arial, Helvetica, sans-serif ; font-size:12px; color:#333333">
  <tr >
    ...
    <td style="border-bottom:1px solid #CCCCCC; background-color:#E8FFF9"><cfoutput>#form.dish# count #user.recordcount#</cfoutput></td>
