<cftry>
  ...
  <table cellpadding="4" cellspacing="2" width="100%">
    <tr>
      <td colspan="3" style="color:#fff; background-color:#0a3a5e">Confirmed Attendees </td>
    </tr>
    <tbody>
      ...
      <cfoutput>
      <tr>
        <td width="30%">#qryBooking_lineItems.eventName#</td>
        <td width="10%">#qryBooking_lineItems.bookingTypeLabel#</td>
        <td width="60%"></td>
      </tr>
      </cfoutput>
      </cfoutput>
  ...
  <cfoutput>#narativeOutputP2#</cfoutput>
  <cfcatch type="any">
