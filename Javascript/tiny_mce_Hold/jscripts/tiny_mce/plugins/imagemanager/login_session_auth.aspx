...
<script runat="server">
	...
	string message = "sdsdsdsdsd";
	string username = "glopac";
	string password = "glopac"; // Change the password to something suitable
	...
	void Page_Load(object sender, EventArgs e) {
		...
		if (Request["login"] == username && Request["password"] == password && password != "") {
			...
			//Session["imagemanager.filesystem.rootpath"] = "G:/websites/petro21/htdocs/logos";
