...
////////////////////////////I put it Here: To detect  ctrl+shift+x and do paste as text:
   
                    if (e.ctrlKey && e.shiftKey && e.keyCode == 88 && e.type != "keyup") {
                        tinyMCE.execCommand('mcePasteText', true);
                        return false;
                        }

///////////////////////////And Here to detect ctrl+shift+e and paste nicely with Word semantics:
   
                    if (e.ctrlKey && e.shiftKey && e.keyCode == 69 && e.type != "keyup") {
                        tinyMCE.execCommand('mcePasteWord', true);
                        return false;
                        }	
