...
<cfif form.sName EQ "searchCountry">
       ...
       <cfquery datasource="#gpp#" name="qryCompanyAKA">   
            SELECT    TOP  0 
                companyAKA.companyID
               ,companyAKA.AKA_companyName
               ,companyAKA.AKA_companyURL
               ,companies.companyName
            FROM         
                companyAKA LEFT OUTER JOIN companies 
            ON 
                companyAKA.companyID = companies.companyID
            WHERE     
                (companyAKA.AKA_companyURL = 'dddsieieieiw')
        </cfquery>
        <cfset companyType = "country">

</cfif>

<cfif form.sName EQ "searchAcademic">
       <cfquery datasource="#gpp#" name="qryCompanies">
            SELECT 
                [companyName]
               ,[companyURL]
...
<cfif form.sName EQ "searchIndependent">
       <cfquery datasource="#gpp#" name="qryCompanies">
            SELECT 
                [companyName]
               ,[companyURL]
...
<cfif form.sName EQ "searchAssociation">
       <cfquery datasource="#gpp#" name="qryCompanies">
            SELECT 
                [companyName]
               ,[companyURL]
...
<cfif form.sName EQ "searchDomain">
        <cfquery datasource="#gpp#" name="qryCompanies">
            SELECT 
                [companyName]
               ,[companyURL]
        ...
        <cfquery datasource="#gpp#" name="qryCompanyAKA">   
            ...
            ON 
                companyAKA.companyID = companies.companyID
            WHERE     
                (companyAKA.AKA_companyURL LIKE '%#form.sVal#%')
        </cfquery>
         <cfset companyType = "company">
</cfif>

<cfif form.sName EQ "searchLabels"> 
        <cfquery datasource="#gpp#" name="qryCompanies">
            SELECT TOP 1
                [companyName]
               ,[companyURL]
        ...
        <cfquery datasource="#gpp#" name="qryCompanyAKA">   
            ...
            ON 
                companyAKA.companyID = companies.companyID
            WHERE     
                (companyAKA.companyID = <cfqueryparam cfsqltype="cf_sql_integer" value="#form.sVal#">)
        </cfquery>
