<cfif parameterexists(url.delete)>
    ...
    DELETE FROM Mediareview WHERE id = <cfqueryparam cfsqltype="cf_sql_integer" value="#url.delete#">
    </cfquery>
</cfif>


<cfquery datasource="#dsnP21#" name="get">SELECT id, title, source FROM Mediareview WHERE bookid = #url.id# </cfquery>    
...
<div style="border-bottom:1px dotted ##CCCCCC; padding:3px">
	<div><a href="play.cfm?id=#get.id#" id="video#get.id#" onClick="return hs.htmlExpand(this, { contentId: 'video', objectType: 'iframe',		objectWidth: 630, objectHeight: 400} )" class="highslide" style="text-decoration:none">#title#</a></div>
