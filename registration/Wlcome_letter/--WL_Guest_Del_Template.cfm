...
<!--- get all events loop ---->
    <cfquery datasource="#gpp#" name="getall">
        ...
        FROM 
        	 tblAnnual_Conf
        WHERE 
        	groupby = #get.groupby# AND event_year = '#get.event_year#' AND (event_type = 'week' OR event_type = 'event' OR event_type = 'EB' OR event_type = 'DIN') 
        ORDER 
...
<!--- get colors --->
		<cfquery datasource="#gpp#" name="getGroup">
			...
			FROM 
            	 tblAnnual_Conf 
           WHERE groupby = #getall.groupby# AND event_year = #getall.event_year# AND event_type = 'week'
		</cfquery>
    ...
    <tr>
    	<td colspan="2"  height="150" bgcolor="##F3F3F3">
		  ...
		  <cfif get.event_type EQ "event" ><cfset eventType = "conference" >
			    We  thank your registration/ request to the <strong>#get.event_name#</strong> on the <strong>#qry_eventDateFormatWeek#</strong>. Please find herewith details for the conference.
          <cfelseif get.event_type EQ "eb" ><cfset eventType = "Briefing" >
                We  thank your registration/ request to the <strong>#get.event_name#</strong> on the <strong>#qry_eventDateFormatWeek#</strong>. Please find herewith details for the Briefing.
          <cfelseif get.event_type EQ "din" ><cfset eventType = "Dinner" >
          		We  thank your registration/ request for <strong>#get.event_name#</strong> on the <strong>#qry_eventDateFormatWeek#</strong>. Please find herewith details for the Dinner.
...
<!--- STart show other events on the week --->
 		<table width="100%" border="0" cellspacing="3" cellpadding="4" style="font-family:Arial, Helvetica, sans-serif; font-size:11px" >
            ...
            <cfif getall.webid  NEQ get.webid AND getall.event_type NEQ "week" >
            <tr>
            ...
            <tr> 
             ...
             <tr>
                ...
                <div style="margin:20px 0 0 0">
                    ...
                    <td bgcolor="##ffffff"><span style="padding:0 0 0 15px;">#function.title# Sponsor: <strong></strong></span></td><td width="105"><img src="http://www.petro21.com/logos/#function.logofile#" width="105" height="45" /></td>
                    </tr></table>
                </div>
                </cfif>
                </td>
...
only) made before the <strong>#dateformat(twoWeekBefore, "dd mmmm yyyy")#</strong> prior to start of #eventType# will be refunded. Thereafter, refunds will not apply<cfif get.event_type NEQ "din"> but delegates will receive online access to relevant Conference Presentations</cfif>. Replacements are welcome.<br />
