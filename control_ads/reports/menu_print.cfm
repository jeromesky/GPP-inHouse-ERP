...
<cfoutput>
<table border="0" cellpadding=2 bgcolor="White" cellspacing=0 width=100%>
	<tr>
		<td colspan="2" bgcolor="White"><font color="Black" Face="Arial" Size="2"><b>Report Information</td>
	</tr>
	<tr>
		<td bgcolor="White">
		<center>
...
<table border="0" cellpadding=0 bgcolor="White" cellspacing=0 width="100%">
	<tr>
		...
		<center>
			<table border="0" bgcolor="White" cellpadding="2" cellspacing="0" width=100%>
				<tr>
		<td colspan="2" bgcolor="White"><font color="Black" Face="Arial" Size="2"><b>Date Selection</td>
				<tr>
			</table>
		</td>
	</tr>
	<Tr>
		<td bgcolor="White"><center>
			<table border="0" bgcolor="White" border="0" cellpadding="2" cellspacing="0">
				<tr>
