  ...
  <td><center>
   <table>
    <tr>
     <td colspan=2>
       <center>
         <font face="Tahoma,Arial" color="navy" size="4"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I M P R E S S I O N &nbsp; -- &nbsp; A N A L Y S I S&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font>
     </td>
    </tr>
   </table>
<script>
   ...
   <table width="500">
    <tr>
     <td>
      ...
      <table border="0">
       <tr>
        <td width="15"><a href="impanalysis.cfm<cfif isDefined("Server")>?Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#</cfif>"><img src="../i/ref.gif" alt="Refresh" border="0" align="absmiddle"></a></td>
        <td><a href="impanalysis.cfm<cfif isDefined("Server")>?Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#</cfif>"><font face="Tahoma,Arial" color="Navy" size="1">refresh</font></a></td>
        <td width="5">&nbsp;</td>
        <td width="15"><a target="_blank" href="impanalysisprint.cfm<cfif isDefined("Server")>?Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#</cfif>"><img src="../i/printer.gif" alt="Print" border="0" align="absmiddle"></a></td>
        <td><a target="_blank" href="impanalysisprint.cfm<cfif isDefined("Server")>?Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#</cfif>"><font face="Tahoma,Arial" color="Navy" size="1">print</font></a></td>
        <td width="5">&nbsp;</td>
        <td width="15"><a href="export.cfm?Action=ExportImpAnalysis<cfif isDefined("Server")>&Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#</cfif>&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#"><img src="../i/export.gif" alt="Export" border="0" align="absmiddle"></a></td>
        <td><a href="export.cfm?Action=ExportImpAnalysis<cfif isDefined("Server")>&Server=#Server#&Sizes=#Sizes#&Categories=#Categories#&Clients=#Clients#</cfif>&StartDate=#UrlEncodedFormat(StartDate)#&EndDate=#UrlEncodedFormat(EndDate)#"><font face="Tahoma,Arial" color="Navy" size="1">export</font></a></td>
       </tr>
      </table>
      </cfoutput>
     </td>
     <td align="right">
      <table border="0">
       <tr>
        <td><a href="javascript:WinOpen('help.cfm?Action=ImpAnalysis', 500,500)"><img src="../i/help.gif" alt="Help" border="0" align="absmiddle"></a></td>
        <td><a href="javascript:WinOpen('help.cfm?Action=ImpAnalysis', 500,500)"><font face="Tahoma,Arial" color="Navy" size="1">help</font></a></td>
       </tr>
      </table>
     </td>
    </tr>
...
<table cellpadding="1" cellspacing="0" width="500"><tr><td bgcolor="black">
 <table width="100%" bgcolor="FFFFEE" cellpadding="2" cellspacing="0">
  ...
  <td bgcolor="black" align="middle"><font color="White" Face="Arial" Size="1"><b>Imp.Remaining</td>
 ...
 <cfoutput query="qGetReport">
  ...
  <td bgcolor="FFFFEE" align="middle"><font color="Black" Face="Arial" Size="1"><cfif iMaxImpressions neq "0">#RemImp#<cfelse>n/a</cfif></td>  
  ...
  <td bgcolor="FFFFEE" align="middle"><cfif vchImageURL neq ""><a href="javascript:viewlocalbanner('#vchImageURL#')"><img src="i/magw.gif" border="0"><cfelse>&nbsp;</cfif></a></td> 
  </tr>
 </cfoutput>
 </table>
</td></tr></table>
