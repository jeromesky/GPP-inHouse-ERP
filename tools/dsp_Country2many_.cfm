...
AND 
	dbo.tblIndividual.companyID NOT IN (6003,0,7803,7804,7805,7806,7807,7808,7809,7810,7811,-1001,-100) 
</cfquery>
...
<!---  AND
    ...
    AND
        (dbo.tblIndividual.branchID IN (-13,-113, -12,-112, -11,-111, -10)) 
  and dbo.tblIndividual.companyID not in (0,7803,7804,7805,7806,7807,7808,7809,7810,7811,-1001, -100)
ORDER BY dbo.tblIndividual.strStreet_Adress #url.searching#
</cfquery>
