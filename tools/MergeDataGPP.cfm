...
<cfloop query="getData">
			...
			SET 
                 ...
                 WHERE lngIndividual_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#getData.IngIndividual_ID#" >
            </cfquery>

			
        		<cfquery datasource="#dsnP21#" name="addMark" >UPDATE email_news SET FlagDelay   = 1  WHERE id = <cfqueryparam cfsqltype="cf_sql_integer" value="#getData.id#"></cfquery>
