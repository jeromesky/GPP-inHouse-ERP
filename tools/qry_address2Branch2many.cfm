...
<cfif NOT parameterexists(form.noCreate)>
            ...
            <cfquery datasource="#gpp#">
                ...
                SET 
                  ...
                  ,[postalCityID]				= <cfif form.postalCityID NEQ ""><cfqueryparam cfsqltype="cf_sql_integer" value="#form.postalCityID#"><cfelse><cfqueryparam cfsqltype="cf_sql_integer" value="0"></cfif>
                  ...
                  ,[streetCityID]				= <cfif form.streetCityID NEQ ""><cfqueryparam cfsqltype="cf_sql_integer" value="#form.streetCityID#"><cfelse><cfqueryparam cfsqltype="cf_sql_integer" value="0"></cfif>
...
<cflocation url="#HTTP_REFERER#" addtoken="no"><!---?searching=#form.URLsearching#&searchingCompanyID=#URLsearchingCompanyID#&searchingCountryID=#form.URLsearchingCountryID#--->