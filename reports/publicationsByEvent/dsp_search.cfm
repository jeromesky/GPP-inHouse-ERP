...
<div class="c4">
		...
		<div class="ui-corner-bottom marginBottom15  ui-widget ui-widget-content  podForm ">
        		<label> <input type="radio" name="fa" id="html" class="external" value="publicationsByEvent-result-html" checked="checked" />print to screen </label><br />
                <label> <input type="radio" name="fa" id="pdf" class="external" value="publicationsByEvent-result-pdf"  />PDF </label><br />
      			<label> <input type="radio" name="fa" id="excel" class="external" value="publicationsByEvent-result-xls" />Excel </label><br />
                <hr />
